...
export default function page() {
  ...
  const [materialCode, setMaterialCode] = useState("#000000");
  ...
  const handleSubmit = (e) => {
    ...
    console.log({ materialName, materialCode, order });
  };
  return (
    <div>
      <div className="max-w-3xl ml-[50px] mt-10 p-6 bg-white rounded-2xl shadow border">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {/* <div>
            <label className="block font-medium mb-1">material Picker</label>
            <input
              type="material"
              value={materialCode}
